...
rt.plot_rays(rays=rt.intersect_plane(rays=rays, zf=obj.ffp+10, ri_in=1.0),
             ...
             save_path=savedir / Path("simulation_raytrace.png"),
             showfig=showfig)
...
pt.plot_field(fields=[initial_field_simulation],
              ...
              gamma_scale=1.0,
              save_path=savedir / Path('simulation_field'),
              showfig=showfig)
...
pt.plot_xz_projection(fields=[field_simulation],
                      ...
                      grid_params=[grid_params],
                      gamma_scale=1.0,
                      save_path=savedir / Path('psf_zx_projection'),
                      showfig=showfig)
